...
for the last two seconds there are visibly two cars and ours is the one in
front. That gap is the whole 0.023, drawn as distance.

Our recording stops sampling 50 ms before his, so the clip is **trimmed at our
last live frame** rather than running on to his — one frame of frozen camera,
cut. The camera stays on our car.
