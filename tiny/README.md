...
*latest lap **36.982** (build ship18f) — staged, awaiting the opening check*
...
*latest lap **43.462** (build ship18f) — staged, awaiting the opening check*
...
*latest lap **93.717** (build ship15) — staged, awaiting the opening check*
