...
*latest lap **42.454** (build ship15) — held (staged — records: 42.454 on ship17c (certified; checker QUALIFIED with two items for the parent; final burst set excludes it — 2026-09-11 12:55Z))*
