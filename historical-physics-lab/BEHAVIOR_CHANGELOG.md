...
| Staged 2022-09-21 / public 2022-10-01 (Fall 2022) | Sep 30 and Oct 6 clients differ in 2 of 20 tracked files and share the canonical-trajectory digest `5ed96a35…04323`. **October 1 is a release date, not the executable boundary.** | No measured trajectory delta; the reconstructed adapter matches stock current on every event. **Unresolved**, fail-closed. |
