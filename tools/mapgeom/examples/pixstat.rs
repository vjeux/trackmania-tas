...
fn main() {
    ...
    for y in y0..y1.min(h) { for x in x0..x1.min(w) {
        ...
        if r > 170 && g > 130 && b < 110 && r as i32 - b as i32 > 80 { yellow += 1 } else if r > 150 && g < 80 && b < 80 { red += 1 } else if mx - mn < 18 && mx > 60 && mx < 200 { grey += 1 } else if g > r + 15 && g > b + 15 { green += 1 } else if b > r + 15 && b >= g { blue += 1 } else { other += 1 }
    }}
    println!("{}x{} region {}..{} x {}..{}: yellow {:.2}% red {:.2}% grey {:.1}% green {:.1}% blue {:.1}% other {:.1}%", w, h, x0, x1, y0, y1, 100.0 * yellow as f64 / n as f64, 100.0 * red as f64 / n as f64, 100.0 * grey as f64 / n as f64, 100.0 * green as f64 / n as f64, 100.0 * blue as f64 / n as f64, 100.0 * other as f64 / n as f64);
}
